...
const router=express.Router();
   ...
   export async function sentEmail(receiver){
    ...
    var mailOptions={
        ...
        text:`Hi! There, You Forgot your password? We received a request to reset your password. Click on the link or Copy paste the URl in your browser.   http://6310594b9a41810008b6a3e7--prismatic-syrniki-2f6692.netlify.app/Onstream/forgotPassword/${receiver}/${token} The provided link will expire in 10 minutes. Thanks`,
...
export async function sentRegistrationEmail(receiver){
    ...
    var mailOptions={
        ...
        text:`Hi! There, You have recently visited our website and entered your email. Please follow the given link to verify your email below.   http://6310594b9a41810008b6a3e7--prismatic-syrniki-2f6692.netlify.app/Onstream/AccountConfirmation/${receiver}/${token} Thanks`,
